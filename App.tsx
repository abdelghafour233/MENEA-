...
import AdDiscovery from './components/AdDiscovery.tsx';
import SeasonalTrends from './components/SeasonalTrends.tsx';
...
const App: React.FC = () => {
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case 'discovery': return <AdDiscovery />;
      case 'seasonal': return <SeasonalTrends />;
      default:
        return (
          <div className="flex flex-col items-center justify-center h-[60vh] space-y-4 text-center">
            ...
            <p className="text-gray-500">نحن نعمل على إضافة ميزات جديدة هنا قريباً.</p>
          </div>
        );
    }
  };
  ...
  return (
    <div className="flex h-screen bg-gray-50 overflow-hidden" dir="rtl">
      ...
      <main className="flex-1 flex flex-col min-w-0 overflow-hidden relative">
        <header className="h-20 bg-white border-b border-gray-100 flex items-center justify-between px-4 md:px-8 z-30 flex-shrink-0">
          ...
          <div className="flex items-center gap-2 md:gap-3 mr-auto">
            <button className="p-2.5 text-gray-500 hover:bg-gray-50 rounded-xl relative">
              <Bell size={20} />
            ...
            <button className="flex items-center gap-3 pl-2 pr-1 py-1 rounded-xl hover:bg-gray-50 transition-colors border border-transparent hover:border-gray-100">
              <div className="text-right hidden sm:block">
                ...
                <p className="text-[10px] text-indigo-600 font-medium">حساب برو</p>
              </div>
        ...
        <div className="flex-1 overflow-y-auto p-4 md:p-8">
          ...
          <footer className="mt-16 py-8 border-t border-gray-100 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-gray-400 font-medium">
            <p>© 2024 Minea Arabic - منصة اكتشاف المنتجات</p>
