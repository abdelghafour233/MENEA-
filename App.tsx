        ...
        <header className="h-20 bg-white border-b border-gray-100 flex items-center justify-between px-8 z-30 flex-shrink-0">
          <div className="flex-1 max-w-xl hidden md:block">
            <div className="relative group">
              ...
              <input type="text" placeholder="ابحث بسرعة عن أي منتج..." className="w-full pr-10 pl-4 py-2.5 bg-gray-50 border-transparent rounded-xl focus:bg-white focus:ring-2 focus:ring-indigo-100 focus:border-indigo-500 outline-none transition-all text-sm" />
            </div>
          </div>
